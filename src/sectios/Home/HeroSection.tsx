    ...
    <>
      <div className="relative h-72 sm:h-[500px] md:h-[500px] w-full bg-cover bg-center bg-[url('/images/head.jpg')]">
        <div className="absolute inset-0 bg-opacity-40 mt-20 flex flex-col items-center justify-center text-center text-white p-6">
          <h1 className="text-xl sm:text-2xl md:text-4xl font-bold mb-2 text-gray-50" data-aos="zoom-in-up">Hai kamu, <span className="">mau ke mana?</span></h1>
          <p className="mb-6 text-lg sm:text-xl text-gray-100" data-aos="zoom-in-up">Satu aplikasi untuk kebutuhan liburanmu.</p>

          {/* Input Pencarian untuk Mobile */}
          <div className="w-full max-w-md mb-6 sm:hidden" data-aos="zoom-in-dwon">
          ...
          <div className="hidden sm:grid grid-cols-3 sm:grid-cols-3 md:grid-cols-6 gap-6">
            {categories.map((item, index) => (
              <div key={index} className="flex flex-col items-center" data-aos="zoom-in-down">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-3 sm:hidden gap-3 mt-5" >
        {categories.map((item, index) => (
          <div key={index} className="flex flex-col items-center" data-aos="zoom-in-up">
